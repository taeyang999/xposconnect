  ...
  useEffect(() => {
    const loadTemplates = async () => {
      ...
      if (templateRecord && templateRecord.length > 0) {
        ...
        setPermissions({
          admin: {
            can_manage_customers: savedTemplates.admin_can_manage_customers !== undefined ? savedTemplates.admin_can_manage_customers : true,
            can_delete_customers: savedTemplates.admin_can_delete_customers !== undefined ? savedTemplates.admin_can_delete_customers : true,
            can_view_customers: savedTemplates.admin_can_view_customers !== undefined ? savedTemplates.admin_can_view_customers : true,
            can_manage_schedule: savedTemplates.admin_can_manage_schedule !== undefined ? savedTemplates.admin_can_manage_schedule : true,
            can_delete_schedule: savedTemplates.admin_can_delete_schedule !== undefined ? savedTemplates.admin_can_delete_schedule : true,
            can_view_schedule: savedTemplates.admin_can_view_schedule !== undefined ? savedTemplates.admin_can_view_schedule : true,
            can_manage_service_logs: savedTemplates.admin_can_manage_service_logs !== undefined ? savedTemplates.admin_can_manage_service_logs : true,
            can_delete_service_logs: savedTemplates.admin_can_delete_service_logs !== undefined ? savedTemplates.admin_can_delete_service_logs : true,
            can_view_service_logs: savedTemplates.admin_can_view_service_logs !== undefined ? savedTemplates.admin_can_view_service_logs : true,
            can_manage_inventory: savedTemplates.admin_can_manage_inventory !== undefined ? savedTemplates.admin_can_manage_inventory : true,
            can_delete_inventory: savedTemplates.admin_can_delete_inventory !== undefined ? savedTemplates.admin_can_delete_inventory : true,
            can_view_inventory: savedTemplates.admin_can_view_inventory !== undefined ? savedTemplates.admin_can_view_inventory : true,
            can_manage_employees: savedTemplates.admin_can_manage_employees !== undefined ? savedTemplates.admin_can_manage_employees : true,
            can_view_reports: savedTemplates.admin_can_view_reports !== undefined ? savedTemplates.admin_can_view_reports : true,
            can_export_data: savedTemplates.admin_can_export_data !== undefined ? savedTemplates.admin_can_export_data : true,
          },
          manager: {
            can_manage_customers: savedTemplates.manager_can_manage_customers !== undefined ? savedTemplates.manager_can_manage_customers : true,
            can_delete_customers: savedTemplates.manager_can_delete_customers !== undefined ? savedTemplates.manager_can_delete_customers : true,
            can_view_customers: savedTemplates.manager_can_view_customers !== undefined ? savedTemplates.manager_can_view_customers : true,
            can_manage_schedule: savedTemplates.manager_can_manage_schedule !== undefined ? savedTemplates.manager_can_manage_schedule : true,
            can_delete_schedule: savedTemplates.manager_can_delete_schedule !== undefined ? savedTemplates.manager_can_delete_schedule : true,
            can_view_schedule: savedTemplates.manager_can_view_schedule !== undefined ? savedTemplates.manager_can_view_schedule : true,
            can_manage_service_logs: savedTemplates.manager_can_manage_service_logs !== undefined ? savedTemplates.manager_can_manage_service_logs : true,
            can_delete_service_logs: savedTemplates.manager_can_delete_service_logs !== undefined ? savedTemplates.manager_can_delete_service_logs : true,
            can_view_service_logs: savedTemplates.manager_can_view_service_logs !== undefined ? savedTemplates.manager_can_view_service_logs : true,
            can_manage_inventory: savedTemplates.manager_can_manage_inventory !== undefined ? savedTemplates.manager_can_manage_inventory : true,
            can_delete_inventory: savedTemplates.manager_can_delete_inventory !== undefined ? savedTemplates.manager_can_delete_inventory : true,
            can_view_inventory: savedTemplates.manager_can_view_inventory !== undefined ? savedTemplates.manager_can_view_inventory : true,
            can_manage_employees: savedTemplates.manager_can_manage_employees !== undefined ? savedTemplates.manager_can_manage_employees : false,
            can_view_reports: savedTemplates.manager_can_view_reports !== undefined ? savedTemplates.manager_can_view_reports : true,
            can_export_data: savedTemplates.manager_can_export_data !== undefined ? savedTemplates.manager_can_export_data : true,
          },
          employee: {
            can_manage_customers: savedTemplates.employee_can_manage_customers !== undefined ? savedTemplates.employee_can_manage_customers : true,
            can_delete_customers: savedTemplates.employee_can_delete_customers !== undefined ? savedTemplates.employee_can_delete_customers : false,
            can_view_customers: savedTemplates.employee_can_view_customers !== undefined ? savedTemplates.employee_can_view_customers : true,
            can_manage_schedule: savedTemplates.employee_can_manage_schedule !== undefined ? savedTemplates.employee_can_manage_schedule : true,
            can_delete_schedule: savedTemplates.employee_can_delete_schedule !== undefined ? savedTemplates.employee_can_delete_schedule : false,
            can_view_schedule: savedTemplates.employee_can_view_schedule !== undefined ? savedTemplates.employee_can_view_schedule : true,
            can_manage_service_logs: savedTemplates.employee_can_manage_service_logs !== undefined ? savedTemplates.employee_can_manage_service_logs : true,
            can_delete_service_logs: savedTemplates.employee_can_delete_service_logs !== undefined ? savedTemplates.employee_can_delete_service_logs : false,
            can_view_service_logs: savedTemplates.employee_can_view_service_logs !== undefined ? savedTemplates.employee_can_view_service_logs : true,
            can_manage_inventory: savedTemplates.employee_can_manage_inventory !== undefined ? savedTemplates.employee_can_manage_inventory : false,
            can_delete_inventory: savedTemplates.employee_can_delete_inventory !== undefined ? savedTemplates.employee_can_delete_inventory : false,
            can_view_inventory: savedTemplates.employee_can_view_inventory !== undefined ? savedTemplates.employee_can_view_inventory : false,
            can_manage_employees: savedTemplates.employee_can_manage_employees !== undefined ? savedTemplates.employee_can_manage_employees : false,
            can_view_reports: savedTemplates.employee_can_view_reports !== undefined ? savedTemplates.employee_can_view_reports : false,
            can_export_data: savedTemplates.employee_can_export_data !== undefined ? savedTemplates.employee_can_export_data : false,
          },
        });
      }
    };
