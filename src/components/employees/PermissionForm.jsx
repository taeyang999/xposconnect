  ...
  useEffect(() => {
    if (permissions.length > 0) {
      ...
      setFormData({
        ...
        can_manage_customers: perm.can_manage_customers !== undefined ? perm.can_manage_customers : true,
        can_delete_customers: perm.can_delete_customers !== undefined ? perm.can_delete_customers : true,
        can_view_customers: perm.can_view_customers !== undefined ? perm.can_view_customers : true,
        can_manage_schedule: perm.can_manage_schedule !== undefined ? perm.can_manage_schedule : true,
        can_delete_schedule: perm.can_delete_schedule !== undefined ? perm.can_delete_schedule : true,
        can_view_schedule: perm.can_view_schedule !== undefined ? perm.can_view_schedule : true,
        can_manage_service_logs: perm.can_manage_service_logs !== undefined ? perm.can_manage_service_logs : true,
        can_delete_service_logs: perm.can_delete_service_logs !== undefined ? perm.can_delete_service_logs : true,
        can_view_service_logs: perm.can_view_service_logs !== undefined ? perm.can_view_service_logs : true,
        can_manage_inventory: perm.can_manage_inventory !== undefined ? perm.can_manage_inventory : true,
        can_delete_inventory: perm.can_delete_inventory !== undefined ? perm.can_delete_inventory : true,
        can_view_inventory: perm.can_view_inventory !== undefined ? perm.can_view_inventory : true,
        can_manage_employees: perm.can_manage_employees !== undefined ? perm.can_manage_employees : false,
        can_view_reports: perm.can_view_reports !== undefined ? perm.can_view_reports : false,
        can_export_data: perm.can_export_data !== undefined ? perm.can_export_data : false,
      });
    } else {
